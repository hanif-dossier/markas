...
// Juga menerima Web Push (notifikasi adzan dari Edge Function adzan-push) dan membuka Markas saat notifikasi diketuk.
const CACHE = 'markas-v3';
...
self.addEventListener('push', e => {
  let p = {}; try { p = e.data ? e.data.json() : {}; } catch { p = { title: 'Markas', body: e.data ? e.data.text() : '' }; }
